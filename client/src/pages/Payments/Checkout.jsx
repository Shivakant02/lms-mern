    ...
    <HomeLayout>
      ...
      >
        <div className=" w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          ...
          <div className=" px-4 spay5 text-center">
            ...
            <p className=" flex items-center justify-center gap-1 text-2xl font-bold text-yellow-500 mt-2">
              <BiRupee />
              <span>499</span> only
            </p>
            ...
            <button
              type="submit"
              className=" bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300  absolute bottom-0 w-full left-0 text-xl font-bold rounded-br-lg rounded-bl-lg py-1"
            >
              Buy now
            </button>
          </div>
